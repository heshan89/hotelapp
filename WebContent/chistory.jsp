...
<html lang="en">
  ...
  <body class="inner">
  	<%
		...
		Map<Integer, List<PlacedOrderItemDTO>> orderHistorySesObj = (Map<Integer, List<PlacedOrderItemDTO>>)Optional.ofNullable(request.getAttribute("hystoryData")).orElse(new HashMap<>());
	%>
    <header>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <h2 class="main-title"><a href="checkerhome.jsp" class="back"><i class="fa-solid fa-chevron-left"></i></a> Order History</h2>
      ...
      <form id="" action="CheckerHistoryServelet" method="get">
        <div class="row">
          <div class="col-6 col-sm-6 col-md-4 col-lg-2">
            <label class="form-label" for="updatedDate">Date</label>
            <div class="input-group input-group-sm">
              <input type="date" class="form-control form-control-sm" name="filterDate" id="date" placeholder="DD/MM/YYYY" value=<%=filterOrderDate%>>
